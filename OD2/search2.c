...
{
    size_t i,j,k,nrows=2*LEN,ncols=4*LEN,row,col;
    unsigned throw;
...
void partitions(int n,
                ...
                unsigned clen)
{
    register size_t i,a,b,len=2*LEN;
    unsigned check,D=3*floor(LEN/3.0)+3;
    UINT sum,**G;
